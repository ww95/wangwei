...
<section id="content_wrapper">
    <section id="content" class="table-layout animated fadeIn">
        <div class="tray tray-center">
            ...
            <form action="${pageContext.request.contextPath}/backstage/admin/update-change-password" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password"class="form-control" id="exampleInput3" aria-describedby="emailHelp"  placeholder="请输入昵称" name="password">
                </div>
                <div class="form-group">
